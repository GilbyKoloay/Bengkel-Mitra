...
export default function Invoice() {
  ...
  function filtered_invoices() {
    return _invoices?.filter(invoice =>
      ...
      (!createDate.split('T')[1].split(':')[0] || invoice.createDate?.split('T')[1].split(':')[0].includes(createDate.split('T')[1].split(':')[0])) &&
      (!createDate.split('T')[1].split(':')[1] || invoice.createDate?.split('T')[1].split(':')[1].includes(createDate.split('T')[1].split(':')[1])) &&
      ...
      (!entryDate.split('T')[1].split(':')[0] || invoice.entryDate?.split('T')[1]?.split(':')[0]?.includes(entryDate.split('T')[1].split(':')[0])) &&
      (!entryDate.split('T')[1].split(':')[1] || invoice.entryDate?.split('T')[1]?.split(':')[1]?.includes(entryDate.split('T')[1].split(':')[1])) &&
      ...
      (!outDate.split('T')[1].split(':')[0] || invoice.outDate?.split('T')[1]?.split(':')[0]?.includes(outDate.split('T')[1].split(':')[0])) &&
      (!outDate.split('T')[1].split(':')[1] || invoice.outDate?.split('T')[1]?.split(':')[1]?.includes(outDate.split('T')[1].split(':')[1])) &&
        ...
        <Table
          ...
          data={filtered_invoices()?.map((invoice, index) => (
            <tr key={index}>
              ...
              <td className='text-right'>Rp. {splitString(invoice.totalPrice, 3, '.')}</td>
